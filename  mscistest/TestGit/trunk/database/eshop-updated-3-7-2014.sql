...
INSERT INTO `category` VALUES ('8', '6', 'Metal');
...
INSERT INTO `order` VALUES ('70', '2014-07-02 10:22:20', '0000-00-00 00:00:00', '8', 'np34GLFDc5r+2Ax3fBUMUUj+k/U8pFerP7et5NeMJKM=', '0', '53b3dd5c40213');
INSERT INTO `order` VALUES ('71', '2014-07-02 15:00:14', '0000-00-00 00:00:00', '12', 'UYLY+PSwqOQcy6KrHwYlE0fH2n8YmBrVSqJKyRgI23Y=', '0', '53b41e7e67ae6');
INSERT INTO `order` VALUES ('72', '2014-07-02 15:04:39', '0000-00-00 00:00:00', '10', 'qMnSAfNVu3NMTcpYMPG1ZHPFtu9k0XNkLJhxvM3IWlM=', '0', '53b41f8701299');
INSERT INTO `order` VALUES ('73', '2014-07-02 15:06:15', '0000-00-00 00:00:00', '10', 'UYLY+PSwqOQcy6KrHwYlE0fH2n8YmBrVSqJKyRgI23Y=', '0', '53b41fe764a0f');
INSERT INTO `order` VALUES ('74', '2014-07-02 16:41:02', '0000-00-00 00:00:00', '1', 'TkrV+k6aRDP/pd8MiSp4o2fg3rA5cYGcGeQS9lzkW6Y=', '0', '53b4361e27b43');
INSERT INTO `order` VALUES ('75', '2014-07-02 18:43:28', '0000-00-00 00:00:00', '1', 'we9WFxqGiP+O1n7FTgLG4vWK+p2goOUkrVt3eoWawME=', '0', '53b452d06cff9');
INSERT INTO `order` VALUES ('76', '2014-07-02 23:25:14', '0000-00-00 00:00:00', '1', 'we9WFxqGiP+O1n7FTgLG4vWK+p2goOUkrVt3eoWawME=', '0', '53b494dab09b3');
INSERT INTO `order` VALUES ('77', '2014-07-03 11:40:25', '0000-00-00 00:00:00', '1', 'np34GLFDc5r+2Ax3fBUMUUj+k/U8pFerP7et5NeMJKM=', '0', '53b541299b8ae');
INSERT INTO `order` VALUES ('78', '2014-07-03 11:40:44', '0000-00-00 00:00:00', '1', 'htFsNF2oBHy/GodKymoa6u51hQLPeFOeyQsGjBCBz6E=', '0', '53b5413c10cc4');
INSERT INTO `order` VALUES ('79', '2014-07-03 12:21:40', '0000-00-00 00:00:00', '1', 'we9WFxqGiP+O1n7FTgLG4vWK+p2goOUkrVt3eoWawME=', '0', '53b54ad444284');
INSERT INTO `order` VALUES ('80', '2014-07-03 15:57:32', '0000-00-00 00:00:00', '15', '8+CkgNJPMOcbYTQBOTOe0T1sB7LJsQcQUvLKuzZq17c=', '0', '53b57d6c62403');
INSERT INTO `product` VALUES ('123456789AAA', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '5000', '100', null, 'test addition', 'grayfox.gif');
INSERT INTO `product` VALUES ('2234242wss23', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '50', '10', null, 'test addition', 'mell.jpg');
INSERT INTO `product` VALUES ('aaaaaaaaaaaf8950', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '50', '10', null, 'test addition', 'raiden.jpg');
INSERT INTO `product` VALUES ('aasdadadadadada2', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '50', '10', null, 'test addition', 'solidsnake.jpg');
INSERT INTO `product` VALUES ('aasefasr43432', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '50', '10', null, 'test addition', 'peacewalker.jpg');
INSERT INTO `product` VALUES ('thisisanothertestREST', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '5000', '100', null, 'test addition', 'peacewalker2.jpg');
INSERT INTO `product` VALUES ('thisisanothertestREST2', 'Lorem Ipsum is simply dummy text of the printing and typesetting', '5000', '100', '2014-06-24 16:25:55', 'test addition', null);
INSERT INTO `products_categories` VALUES ('123456789AAA', '7');
INSERT INTO `products_categories` VALUES ('aasdadadadadada2', '7');
INSERT INTO `products_categories` VALUES ('2234242wss23', '8');
INSERT INTO `products_categories` VALUES ('thisisanothertestREST', '8');
INSERT INTO `products_categories` VALUES ('aasefasr43432', '8');
INSERT INTO `products_categories` VALUES ('thisisanothertestREST2', '7');
INSERT INTO `products_categories` VALUES ('aasefasr43432', '8');
...
INSERT INTO `products_orders` VALUES ('70', '123456789AAA', '99', '1');
INSERT INTO `products_orders` VALUES ('71', '123456789AAA', '100', '1');
INSERT INTO `products_orders` VALUES ('72', 'aasefasr43432', '101', '1');
INSERT INTO `products_orders` VALUES ('73', '123456789AAA', '102', '1');
INSERT INTO `products_orders` VALUES ('74', '2234242wss23', '103', '1');
INSERT INTO `products_orders` VALUES ('75', '2234242wss23', '104', '1');
INSERT INTO `products_orders` VALUES ('75', 'aasdadadadadada2', '105', '1');
INSERT INTO `products_orders` VALUES ('76', 'aasefasr43432', '106', '2');
INSERT INTO `products_orders` VALUES ('77', '123456789AAA', '107', '1');
INSERT INTO `products_orders` VALUES ('78', '2234242wss23', '108', '3');
INSERT INTO `products_orders` VALUES ('79', '2234242wss23', '109', '1');
INSERT INTO `products_orders` VALUES ('79', 'aasefasr43432', '110', '1');
INSERT INTO `products_orders` VALUES ('80', 'aasefasr43432', '111', '3');
...
INSERT INTO `user` VALUES ('9', 'apelole', '6bcdfe9fa19e45154f83295170bdf365', '12121799553b41c70c2c0a2.50910772', 'antoniougeo@hotmail.com', 'tester', 'testre', '1234567890', '0', '0');
INSERT INTO `user` VALUES ('10', 'andsnake3', '56645b2d09a3a51ac3b3aa24fd274e0e', '119375682953b41df28cdd71.18153525', 'ASDAS@ASD.COM', 'tester', 'testre', '1234567890', '0', '0');
INSERT INTO `user` VALUES ('11', '123456789', '9b4f30957fe7f16b532fbc6e84e73319', '140513229953b41e312e0870.12531555', 'AASDAS@ASD.COM', 'tester', 'testre', '1234567890', '0', '0');
INSERT INTO `user` VALUES ('12', '12345678910', '33b8bc3405ee08a8824dc54ec2e6ab9e', '139571496253b41e59e91668.22927735', 'ASDAD@ASDSAD.COM', 'tester', 'testre', '1234567890', '0', '0');
INSERT INTO `user` VALUES ('13', 'andsnake4', 'c7a5a39be7142dc9fe156b30a5d7c3fd', '141432052753b4294cba8558.04813164', 'antoniougeo2@hotmail.com', 'tester', 'testre', '6947343012', '0', '0');
INSERT INTO `user` VALUES ('14', 'andsnake5', 'e5ac4d2dbdbbbaa1ed4ca00563a7f862', '149031462153b4767291fb22.00962233', 'antoniougexo@hotmail.com', 'george', 'antoniou', '6947343012', '0', '0');
INSERT INTO `user` VALUES ('15', 'testuser', '42db3cb6f57275b5d4351ab8517abba6', '192407748353b5483ab444e9.19627819', 'antonioug@hotmail.com', 'George', 'Antoniou', '6999850245', '0', '0');
